...
#         --order 2 \
#         --start_train_step 0 > order_2_step_0.log 2>&1 &
...
#         --alpha_fusion 0.8 > order_2_step_1.log 2>&1 &
...
#         --pseudo \
#         --pseudo_num 4 \
#         --lambda_kl 0.5 > order_2_step_2.log 2>&1 &
...
#         --pseudo \
#         --pseudo_num 2 \
#         --lambda_kl 0.1 > order_2_step_3.log 2>&1 &
...
#         --pseudo \
#         --pseudo_num 4 \
#         --lambda_kl 0.1 > order_2_step_4.log 2>&1 &
...
#         --pseudo \
#         --pseudo_num 4 \
#         --lambda_kl 1.0 > order_1_step_5.log 2>&1 &
