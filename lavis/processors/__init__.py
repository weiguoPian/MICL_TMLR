...
from .blip_diffusion_processors import (
    BlipDiffusionInputImageProcessor,
    BlipDiffusionTargetImageProcessor,
)
...
from .audio_processors import BeatsAudioProcessor
from .ulip_processors import ULIPPCProcessor
from .instruction_text_processors import BlipInstructionProcessor
