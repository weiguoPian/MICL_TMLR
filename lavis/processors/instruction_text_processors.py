...
TEMPLATES = {"image":{}, "pc":{}, "audio":{}, "video":{}, "audio-video":{}}

TEMPLATES["audio-video"]["qa"] = [
"Given the audio-video, {}",
"Q: {} A:",
"Answer the following question based on the audio-video: {}",
"Question: {} Answer:",
"How would you answer {} after watching video and listening the audio?",
"What is the answer to the question {} after viewing the video and listening the audio?",
"Answer the question based on the audio-video. Question: {} Answer: ",
"Instruction: Answer the following question by reference to the input audio-video. Question: {} Answer:",
"Given the audio-video, what is the answer to the question {}?",
"What's your response to the query {} after watching the video and listening the audio?",
"Please provide an answer to {} after watching the video and listening the audio",
"Respond to the query {} based on the audio-video",
"Based on the given audio-video, respond to {}",
"Question: {} What's your response after watching the video and listening the audio?",
"Consider the following query: {}",
"Could you help answer the question {}?",
"Referencing the provided audio-video, can you answer the question {}?",
"With respect to the audio-video shown, please answer {}",
"What's your answer to {} in the context of the provided audio-video?",
"Question (refer to the audio-video for context): {} Answer:",
"In response to the question {}, what would your answer be after viewing the video and listening the audio?"
]

TEMPLATES["audio-video"]["caption"] = [
"A short caption for the audio-video:",
"A short description of the audio-video:",
"An audio-video of",
"An audio-video that shows",
"Describe the audio-video briefly.",
"Write a description for the audio-video.",
"Provide a description of what is presented in the audio-video.",
"Briefly describe the content of the audio-video.",
"Can you briefly explain what you see and hear in the audio-video?",
"Could you use a few words to describe what you perceive in the audio-video?",
"Please provide a short description of the audio-video.",
"Using language, provide a short account of the audio-video.",
"Use a few words to illustrate what is happening in the audio-video."
]
